...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  find-me-gluten-free-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  find-me-gluten-free-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"chains", "cities", "countries",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  find-me-gluten-free-pp-cli workflow status

  # Show status as JSON
  find-me-gluten-free-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("find-me-gluten-free-pp-cli")
			}
