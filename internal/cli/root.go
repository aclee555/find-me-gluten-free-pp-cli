...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "find-me-gluten-free-pp-cli",
		Short: `Cache, compare, and diff Find Me Gluten Free cities from your terminal. Multi-city trip compare, lat/lng radius search, city-wide review feeds, and safety-report filters the consumer app can't show.`,
		Long: `Cache, compare, and diff Find Me Gluten Free cities from your terminal. Multi-city trip compare, lat/lng radius search, city-wide review feeds, and safety-report filters the consumer app can't show.
...
Health check: run 'find-me-gluten-free-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("find-me-gluten-free-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'find-me-gluten-free-pp-cli profile list')")
	...
	wireExtraCommands(rootCmd, flags)
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("find-me-gluten-free-pp-cli %s\n", version)
		},
	}
}
