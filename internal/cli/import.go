...
but do not stop the import.`,
  ...
  find-me-gluten-free-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  find-me-gluten-free-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | find-me-gluten-free-pp-cli import <resource> --input -`,
