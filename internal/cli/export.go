...
large datasets as it has no memory pressure.`,
  ...
  find-me-gluten-free-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  find-me-gluten-free-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  find-me-gluten-free-pp-cli export <resource> --format jsonl | jq '.id'`,
