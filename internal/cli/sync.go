...
Exit codes & warnings:
  ...
  find-me-gluten-free-pp-cli sync

  # Sync specific resources only
  find-me-gluten-free-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  find-me-gluten-free-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  find-me-gluten-free-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  find-me-gluten-free-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  find-me-gluten-free-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"chains": "/chains",
		"cities": "/most-gluten-free-friendly-cities",
		"countries": "/countries",
	}
