# Find Me Gluten Free Printed CLI Agent Guide

This directory is a generated `find-me-gluten-free-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
find-me-gluten-free-pp-cli doctor --json
find-me-gluten-free-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
find-me-gluten-free-pp-cli which "<capability>" --json
find-me-gluten-free-pp-cli <command> --help
```
...
```bash
find-me-gluten-free-pp-cli <command> --agent
```
...
```bash
find-me-gluten-free-pp-cli <command> --help
find-me-gluten-free-pp-cli <command> --dry-run --agent
```
